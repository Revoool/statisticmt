...
with tab4:
    ...
    if "Популярные подкатегории" in df_summary.columns and "Общая прибыль" in df_summary.columns:
        fig2 = px.bar(
        ...
        st.warning("Колонки 'Популярные подкатегории' или 'Общая прибыль' не найдены в таблице.")
